...
class DevicePolicyControllerPlatformImpl
  ...
  void handleBootCompleted(handler) {
    print('Vào handleBootCompleted');
    _methodChannel.setMethodCallHandler((call) async {
      print('Method:: ${call.method}');
      if (call.method == 'handleBootCompleted') {
        print('Vào handle handleBootCompleted');
  ...
  // Future<bool> setDeviceOwner({
  //   required String packageName,
  //   required String receiverName,
  // }) async {
  //   try {
  //     final result = await _methodChannel.invokeMethod('setDeviceOwner', {
  //       'packageName': packageName,
  ...
  //     return true;
  //   } catch (e) {
  //     print("Error setting Device Owner: $e");
  //     return false;
  //   }
  // }
}
